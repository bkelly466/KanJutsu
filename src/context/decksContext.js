 ...
 * a file exporting both a component and a hook breaks Fast Refresh.
 */
 ...
 *
 * Named useDecksContext, not useDecks, to avoid colliding with the
 * hooks/useDecks.js hook it wraps — that one owns the Amplify work and is
 * called exactly once, by DecksProvider.
 */
